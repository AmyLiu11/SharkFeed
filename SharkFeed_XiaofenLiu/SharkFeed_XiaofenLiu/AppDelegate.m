...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.splashViewController = [storyboard instantiateViewControllerWithIdentifier:@"splash"];
...
-(void)onSlashScreenDone{
    ...
    self.photoViewController = [storyboard instantiateViewControllerWithIdentifier:@"photo"];
    [self.window addSubview:self.photoViewController.view];
    [self.window makeKeyAndVisible];
}
